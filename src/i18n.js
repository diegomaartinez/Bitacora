...
export const STRINGS = {
  es: {
    ...
    'dashboard.sharedByTag': 'Compartido por {{host}}',
    ...
    'tripSettings.deleteConfirm': 'Esta acción no se puede deshacer.',
    'tripSettings.deleteTypePrompt': 'Para confirmar, escribe exactamente «{{phrase}}» abajo.',
    'tripSettings.deleteTypePlaceholder': 'Eliminar viaje',
    ...
    'tripSettings.collabRoleViewerTag': 'Visitante',
    'tripSettings.collabRoleEditorTag': 'Editor',
    'tripSettings.participantsToggle': 'Ver participantes',
    'tripSettings.collabOnlyOwner': 'Solo el anfitrión puede gestionar el acceso.',
  ...
  en: {
    ...
    'dashboard.sharedByTag': 'Shared by {{host}}',
    ...
    'tripSettings.deleteConfirm': 'This action cannot be undone.',
    'tripSettings.deleteTypePrompt': 'To confirm, type exactly "{{phrase}}" below.',
    'tripSettings.deleteTypePlaceholder': 'Delete trip',
    ...
    'tripSettings.collabRoleViewerTag': 'Guest',
    'tripSettings.collabRoleEditorTag': 'Editor',
    'tripSettings.participantsToggle': 'View participants',
    'tripSettings.collabOnlyOwner': 'Only the host can manage access.',
